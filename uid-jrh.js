...
async function getDataJurnal(){
	...
	await page.goto("https://ojs.uid.ac.id/index.php/jrh/issue/archive", {timeout: 0})
	...
	const nama_jurnal = "Reformasi Hukum "//await page.$eval(".data strong", text => text.innerText)

	const universitas = "Universitas Islam Jakarta";
